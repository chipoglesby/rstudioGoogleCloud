...
RUN apt-get update && \
  apt-get install -y -qq --no-install-recommends docker.io git wget nano sudo unzip python php5-mysql php5-cli php5-cgi openjdk-7-jre-headless openssh-client python-openssl && \
  apt-get clean && \
